...
class FinancialGrid(CalculatorGrid):
    def __init__(self, calculator_window):
        ...
        buttons = [
            ...
            GridButton("÷", self.on_button_clicked, 5, 0, insert_text="/"),
            GridButton("×", self.on_button_clicked, 6, 0, insert_text="*"),
            ...
            GridButton("−", self.on_button_clicked, 7, 1, insert_text="-"),
            # Row 2
            ...
            GridButton("+", self.on_button_clicked, 7, 2, insert_text="+"),
            # Row 3
