...
PYO3_USE_ABI3_FORWARD_COMPATIBILITY=1 cargo run --manifest-path rust_frontend/Cargo.toml
```
...
2. **Compile**:
   ```bash
   PYO3_USE_ABI3_FORWARD_COMPATIBILITY=1 cargo build --release --manifest-path rust_frontend/Cargo.toml
   ```
