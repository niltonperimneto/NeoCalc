...
PYO3_USE_ABI3_FORWARD_COMPATIBILITY=1 cargo run --manifest-path launcher/Cargo.toml
```
...
2. **Compile**:
   ```bash
   PYO3_USE_ABI3_FORWARD_COMPATIBILITY=1 cargo build --release --manifest-path launcher/Cargo.toml
   ```
